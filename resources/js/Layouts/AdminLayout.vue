...
const isActive = (href) => {
    if (href === '/manage/posts' && page.url.startsWith('/manage/categories')) return true;
    return (page.url.startsWith(href) && href !== '/dashboard/admin' && href !== '/dashboard/perawat') || page.url === href;
};
</script>
