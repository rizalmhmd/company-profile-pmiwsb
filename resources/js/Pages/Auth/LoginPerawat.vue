    ...
    <div class="bg-gray-100 min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8 bg-white p-8 rounded-2xl shadow-xl">
            ...
            <div class="text-center">
                ...
                <h2 class="text-3xl font-bold text-gray-900">Login Perawat</h2>
                <p class="mt-2 text-gray-600">Portal Perawat PMI Wonosobo</p>
            </div>
            ...
            <div class="rounded-lg bg-blue-50 p-4 border border-blue-200">
                <p class="text-sm text-blue-800">
                    ...
                    Email: perawat@pmiwonosobo.or.id<br>
                    Password: password
                </p>
            </div>
        </div>
