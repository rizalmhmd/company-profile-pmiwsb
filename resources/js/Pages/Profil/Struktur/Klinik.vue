...
<template>
    <Head title="Klinik Kesehatan" />
    <MainLayout :footer="footer">
        <HeroSection 
            title="Klinik Kesehatan" 
            subtitle="Struktur Organisasi" 
            description="Layanan kesehatan berkualitas untuk masyarakat Wonosobo melalui Klinik PMI."
        />
        ...
        <div class="container mx-auto px-4 py-16 -mt-8 relative z-20">
            <div class="bg-white rounded-2xl shadow-xl p-8 md:p-12 border border-gray-100 text-center max-w-3xl mx-auto backdrop-blur-sm bg-white/90">
                ...
                <p class="text-gray-500 text-lg">
                    Konten untuk halaman <span class="font-bold text-red-600">Klinik Kesehatan</span> sedang dipersiapkan oleh administrator. 
                </p>
